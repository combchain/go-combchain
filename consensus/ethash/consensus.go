...
func ecrecover(header *types.Header) (common.Address, error) {
	...
	// The signer's address should match the coinbase address in combchain Release 1, shall we add a warning if it's not?
